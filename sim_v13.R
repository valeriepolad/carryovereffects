...
# if traditional method
  ...
  if (carryover_value == 0){
    carryover_0 <- rbind(all_results_traditional,all_results_split_halves)
  }
  if (carryover_value == .05){
    carryover_05 <- rbind(all_results_traditional,all_results_split_halves)
  }
  if (carryover_value == .1){
    carryover_10 <- rbind(all_results_traditional,all_results_split_halves)
  }
  if (carryover_value == .15){
    carryover_15 <- rbind(all_results_traditional,all_results_split_halves)
  }
}
